...
?>
    <section class="register" style="background-image:url(<?php echo get_theme_file_uri() . '/assets/images/BG4.jpg'; ?>)">        
        <div class="container register__container">
            ...
            <form class="register__form" action="<?php echo esc_url(admin_url('admin-post.php')); ?>" method="POST">
                <input type="hidden" name="action" value="forgotpass">
                <input 
                class="input input--green input--large" 
                type="email" 
                id="email" 
                name="email" 
                placeholder="email" 
                ...
                >                                              
                <button class="btn btn--large btn--green">Восстановить</button>
            </form>
        </div>
    </section>
<?php get_footer(); ?>